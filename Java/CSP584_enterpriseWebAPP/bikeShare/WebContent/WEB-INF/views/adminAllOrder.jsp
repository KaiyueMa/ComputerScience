...
<body>
	...
	<div class="templatemo-flex-row">
		...
		<div class="templatemo-content col-1 light-gray-bg">
			<jsp:include page="adminOrderNav.jsp"></jsp:include>
								...
								<div class="panel-body">
									<div>
												...
												<table id="orderinfo"
													...
													<thead>
														<tr>
															...
															<td><a href="" class="white-text templatemo-sort-by">Price<span
																	class="caret"></span></a></td>
															<td><a href="" class="white-text templatemo-sort-by">Check
													...
													<tbody>
														<tr>
															...
															<td>USD ${orderInfo.oldprice}</td>
															<td>USD ${orderInfo.newprice}</td>
										...
										<div class="margin-bottom-10">
											<a
												href="${pageContext.request.contextPath}/AdminOrderServlet?orderid=${orderInfo.orderid}&flag=sendGoods"
												class="templatemo-edit-btn pull-right">Start</a>
										</div>
									</div>
								</div>
							</div>
