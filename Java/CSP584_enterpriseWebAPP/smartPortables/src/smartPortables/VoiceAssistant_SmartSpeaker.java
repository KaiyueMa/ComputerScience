...
@WebServlet("/VoiceAssistant_SmartSpeaker")
...
public class VoiceAssistant_SmartSpeaker extends HttpServlet {
	private String id;
	private String name;
	...
	public VoiceAssistant_SmartSpeaker(String name, double price, String image, String label,String condition,double discount){
		this.name=name;
		this.price=price;
		this.image=image;
	...
	public VoiceAssistant_SmartSpeaker() {
