	...
	protected void doGet(HttpServletRequest request,
		...
		if(action.equals("Addproduct"))
		{
			...
			pw.print("<form method='get' action='ProductCrud'>"
					...
					+ "<h3>Product Type</h3></td><td><select name='producttype' class='input'><option value='wearableTechnologies' selected>WearableTechnology</option><option value='games'>Phone</option><option value='tablets'>Laptops</option><option value='smartSpeakers'>SmartSpeaker</option><option value='accessories'>Accessory</option></select>"
					+ "</td></tr><tr><td>"
