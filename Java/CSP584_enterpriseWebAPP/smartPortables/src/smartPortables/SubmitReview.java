...
//				String retailercity = request.getParameter("retailercity");
	        ...
	        String ManufacturerName = "wearableTeachnology";
	        String ManufacturerRebate = request.getParameter("ProductOnSale"); // ProductOnSale
	        String UserID = utility.session.getAttribute("username").toString();
...
//		String message=utility.storeReview(productname,producttype,productmaker,reviewrating,reviewdate,reviewtext,retailerpin,productprice,retailercity);				     
	        ...
	        String message=utility.storeReview(ProductModelName,ProductCategory,ProductPrice,RetailerName,RetailerZip,
