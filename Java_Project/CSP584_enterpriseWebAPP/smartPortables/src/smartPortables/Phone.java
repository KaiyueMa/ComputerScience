...
public class Phone extends HttpServlet{
	...
	public Phone(String id,String name, double price, String image, String label, String condition,double discount){
		this.id=id;
		this.name=name;
		this.price=price;
		this.image=image;
	...
	public Phone(String name, double price, String image, String label,String condition,double discount){
		this.name=name;
		this.price=price;
		this.image=image;
		this.condition=condition;
