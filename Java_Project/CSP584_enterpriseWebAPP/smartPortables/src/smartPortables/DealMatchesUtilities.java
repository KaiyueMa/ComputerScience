...
public class DealMatchesUtilities extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		pw.print("<h1>We beat our competitors in all aspects. Price-Match Guaranteed</h2>");
			...
			BufferedReader reader = new BufferedReader(new FileReader (new File("/Users/michael/Codes/Java-eclipse/smartPortables/WebContent/DealMatches.txt")));
...
//		
		...
		pw.print("<ul>");
		pw.print("<li id='item'><img src='images/consoles/"+entry.getValue().getImage()+"' alt='' />");
		pw.print("</li><li>");
