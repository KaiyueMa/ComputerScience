...
public class ProductCrud extends HttpServlet {
	protected void doGet(HttpServletRequest request,
			...
			HashMap<String,Wearable_Technology> allconsoles = new HashMap<String,Wearable_Technology> ();
			HashMap<String,Laptop> alltablets = new HashMap<String,Laptop>();
			HashMap<String,Phone> allgames = new HashMap<String,Phone>();
			...
			{
			  			if(producttype.equals("wearableTechnologies")){
			  ...
			  if (productManufacturer.equalsIgnoreCase("Fitness_Watches")) {
					Wearable_Technology wearable_Technology = new Wearable_Technology(productId, productName, productPrice, productImage, productManufacturer, productCondition, productDiscount , null, null);
			...
			}else if(action.equals("update"))
			{
			  ...
			  if (productManufacturer.equalsIgnoreCase("Fitness_Watches")) {
					Wearable_Technology wearableTechnology = new Wearable_Technology(productId, productName, productPrice, productImage, productManufacturer, productCondition, productDiscount , null, null);
