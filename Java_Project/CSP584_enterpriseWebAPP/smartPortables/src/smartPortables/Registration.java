...
//			 hm= (HashMap)objectInputStream.readObject();
	...
	protected void displayRegistration(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Registration'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='manager'>manager</option><option value='salesman'>Salesman</option></select>"
				+ "</td></tr></table>"
