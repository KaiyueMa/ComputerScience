...
public class PhoneList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
		  if(CategoryName.equals("Feature Phone"))
		  {
			for(Map.Entry<String,Phone> entry : SaxParserDataStore.phones.entrySet())
				{
				if(entry.getValue().getLabel().equals("Feature Phone"))
				 {
		  ...
		  else if(CategoryName.equals("Smart Phone"))
		  {
			for(Map.Entry<String,Phone> entry : SaxParserDataStore.phones.entrySet())
				{
				if(entry.getValue().getLabel().equals("Smart Phone"))
				 {
					 hm.put(entry.getValue().getId(),entry.getValue());
				 }
				}	
		...
		for(Map.Entry<String, Phone> entry : hm.entrySet()){
			...
			pw.print("<li id='item'><img src='images/games/"+phone.getImage()+"' alt='' /></li>");
