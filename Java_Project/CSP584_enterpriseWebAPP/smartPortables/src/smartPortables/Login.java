...
//		  hm = (HashMap)objectInputStream.readObject();
	...
	protected void displayLogin(HttpServletRequest request,
		...
		pw.print("<form method='post' action='Login'>"
				...
				+ "</td></tr><tr><td>"
				+ "<h3>User Type</h3></td><td><select name='usertype' class='input'><option value='customer' selected>Customer</option><option value='retailer'>manager</option><option value='manager'>Salesman</option></select>"
				+ "</td></tr><tr><td></td><td>"
