...
<body>
	...
	<!-- Modal -->
	<div class="modal fade" id="update-cate" tabindex="-1" role="dialog"
				...
				<div class="templatemo-content-widget white-bg">
					<div class="templatemo-content-widget no-padding">
						<div class="panel panel-default table-responsive">
							<table id="goodsinfo"
								class="table  table-bordered templatemo-user-table">
								<thead>
									<tr>
										<td>Category Name</td>
										<td></td>
								...
								<tbody>
									<c:forEach items="${categoryList}" var="category">
										<tr>
											...
											<td><button href="" class="templatemo-edit-btn"
													name="changCate">Update</button></td>
											<td><button href="" class="templatemo-delete-btn"
													name="deleteCate">Delete</button></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
					...
					<form
						action="${pageContext.request.contextPath}/AdminCategoryServlet?flag=saveCate"
						method="post">
