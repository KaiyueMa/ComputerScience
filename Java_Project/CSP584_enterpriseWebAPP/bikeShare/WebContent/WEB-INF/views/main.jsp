    ...
    <div>
        ...
        <div class="row">
            <div class="col-md-4" role="navigation">
                <!-- <h1 style="font-size: 20px;margin-top: 9px">咸鱼</h1> -->
        ...
        <div class="row">
            <div class="col-md-4" role="navigation">
                <!-- <h1 style="font-size: 20px;margin-top: 9px"></h1> -->
				...
				<div id="mycarousel" class="carousel slide" data-ride="carousel">
					<div class="carousel-inner">
						<div class="item active">
							<img src="${pageContext.request.contextPath}/image/t_3.jpg" alt="">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/image/t_2.jpg" alt="">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/image/t_4.jpg" alt="">
						</div>
						<div class="item">
							<img src="${pageContext.request.contextPath}/image/t_1.jpg" alt="">
						</div>
					</div>
		...
		<%-- <div class="content">
			<div class="row">
				<div class="col-sm-6 col-md-4">
					<h3>骑行知识</h3>
					<div class="thumbnail">
						<a href="${pageContext.request.contextPath}/newsdetail?goodsid=${meirong.goodsid}">
						<img src="${pageContext.request.contextPath}/shopimage/${meirong.imgepath}" alt="..." >
						</a>
						<div class="caption">
							<h3><a href="${pageContext.request.contextPath}/newsdetail?goodsid=${meirong.goodsid}">${meirong.goodsname}</a></h3>
							<p>${meirong.description}</p>
						</div>
					</div>
				</div>
				<div class="col-sm-6 col-md-4">
				<h3>安全小常识</h3>
					...
					<div class="thumbnail">
						<a href="${pageContext.request.contextPath}/newsdetail?goodsid=${remen.goodsid}">
						<img src="${pageContext.request.contextPath}/shopimage/${remen.imgepath}" alt="...">
						</a>
						<div class="caption">
							<h3><a href="${pageContext.request.contextPath}/newsdetail?goodsid=${remen.goodsid}">${remen.goodsname}</a></h3>
							<p>${remen.description}</p>
				...
				<div class="col-sm-6 col-md-4">
						<h3>热门趣事</h3>
					<div class="thumbnail">
						<a href="${pageContext.request.contextPath}/newsdetail?goodsid=${mingxing.goodsid}">
						<img src="${pageContext.request.contextPath}/shopimage/${mingxing.imgepath}" alt="...">
						</a>
						<div class="caption">
							<h3><a href="${pageContext.request.contextPath}/newsdetail?goodsid=${mingxing.goodsid}">${mingxing.goodsname}</a></h3>
							<p>${mingxing.description}</p>
...
·
		...
		<div class="container" style="margin-top:10px;">
			<button id="load" type="button"
				class="btn btn-default btn-lg btn-block">More Bikes</button>
		</div>
	...
	<script type="text/javascript">
		...
		function getGoodsList(pn) {
			$.ajax({
				url : "${pageContext.request.contextPath}/ShowFrontHomeByPager?pn=" + pn,
				type : "GET",
				"dataType" : "json",
				"data" : {},
				success : function(result) {
				   ...
				   for (var i = 0; i < result.data.length; i++) {
					...
					var a = $("<a></a>").attr("href", "${pageContext.request.contextPath}/ShowFrontGoodDetail?goodsid=" + result.data[i].goodsid).appendTo(div);
					var img = $("<img></img>").attr("src", "${pageContext.request.contextPath}/shopimage/" + result.data[i].imgepath).attr("width", "200").attr("height", "200").appendTo(a);
					var p = $("<p></p>").addClass("text-right").appendTo(li);
					var a2 = $("<a></a>").attr("href", "${pageContext.request.contextPath}/ShowFrontGoodDetail?goodsid" + result.data[i].goodsid).append(result.data[i].goodsname).appendTo(p);
					var div2 = $("<div></div>").addClass("text-right").append($("<b>USD " + result.data[i].price + "</b>")).appendTo(li);
				 ...
				 if(result.pageInfo.totalPage<=pn){
						$("#load").attr("disabled","disabled").html("No more bikes!");
