...
<head>
    ...
    <title>Bike Share - Personal</title>
        ...
        <div class="row">
            ...
            <div class="col-md-5 form-register">
                <div>
                    ...
                    <form class="form-horizontal" id="form" action="${pageContext.request.contextPath}/UserManageServlet?flag=registerresult"
                          method="post">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="password" class="form-control"
                                       id="confirmPassword" name="confirmPassword" placeholder="Re-Password">
                            </div>
                        </div>
                        <div class="form-group">
