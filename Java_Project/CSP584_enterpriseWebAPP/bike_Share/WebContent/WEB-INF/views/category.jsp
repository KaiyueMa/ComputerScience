	...
	<div id="main" class="container">
		...
		<div class="content">
			...
			<div class="btn-group" role="group" aria-label="...">
				<a href="${pageContext.request.contextPath}/category?cate="
					class="btn btn-default" role="button">All</a>
				<c:forEach items="${categoryList}" var="category">
					<a
						href="${pageContext.request.contextPath}/category?cate=${category.catename}"
			...
			<div class="module">
				...
				<div class="bd">
					...
					<div class="row page-div">
						<div class="col-md-5 page-info">Currently page
							${pageInfo.pageNum}, totally ${pageInfo.pages} pages, in total
							${pageInfo.size} records</div>
						<div class="col-md-6">
