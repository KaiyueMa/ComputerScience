				...
				<div class="row">
					<nav class="templatemo-top-nav col-lg-12 col-md-12">
						<ul class="text-uppercase">
							<li><a href="" class="active">All Staff</a></li>
							<li><a
								href="${pageContext.request.contextPath}/AdminUserServlet?flag=ShowClient"
								class="active">All Customers</a></li>
						</ul>
					</nav>
				</div>
			</div>
						...
						<table id="goodsinfo"
							...
							<thead>
								<tr>
									...
									<td><a href="" class="white-text templatemo-sort-by">Staff
